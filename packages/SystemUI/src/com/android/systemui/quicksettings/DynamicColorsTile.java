...
public class DynamicColorsTile extends QuickSettingsTile {

    public boolean mScreenColor = false;
    public boolean mActionBarColor = false;

    public DynamicColorsTile(Context context, final QuickSettingsController qsc) {
        super(context, qsc);
        ...
        mOnClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.STATUS_BAR_TINTED_COLOR,
                    !mScreenColor ? 2 : 0);
        ...
        qsc.registerObservedContent(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_TINTED_COLOR), this);
    }
    ...
    public synchronized void updateTile() {
        mScreenColor = Settings.System.getIntForUser(mContext.getContentResolver(),
        ...
        mActionBarColor = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_TINTED_COLOR, 0,
