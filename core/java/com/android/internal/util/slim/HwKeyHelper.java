...
public class HwKeyHelper {
    ...
    public static String getPressOnHomeBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_HOME;
        if (getDefault) {
            return defaultValue;
        }
    ...
    public static String getLongPressOnHomeBehavior(Context context, boolean getDefault) {
        ...
        if (longPressOnHome == LONG_PRESS_HOME_RECENT_SYSTEM_UI) {
            defaultValue = SlimActionConstants.ACTION_RECENTS;
        } else if (longPressOnHome == LONG_PRESS_HOME_ASSIST){
            defaultValue = SlimActionConstants.ACTION_SEARCH;
        } else {
            defaultValue = SlimActionConstants.ACTION_NULL;
        }
        if (getDefault) {
            return defaultValue;
        }
    ...
    public static String getDoubleTapOnMenuBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_NULL;
        if (getDefault) {
            return defaultValue;
        }
        String value = Settings.System.getStringForUser(
    ...
    public static String getPressOnBackBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_BACK;
        if (getDefault) {
            return defaultValue;
        }
        String value = Settings.System.getStringForUser(
    ...
    public static String getPressOnAssistBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_SEARCH;
        if (getDefault) {
            return defaultValue;
        }
        String value = Settings.System.getStringForUser(
    ...
    public static String getLongPressOnAssistBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_VOICE_SEARCH;
        if (getDefault) {
            return defaultValue;
        }
        String value = Settings.System.getStringForUser(
    ...
    public static String getPressOnAppSwitchBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_RECENTS;
        if (getDefault) {
            return defaultValue;
        }
        String value = Settings.System.getStringForUser(
    ...
    public static String getPressOnCameraBehavior(Context context, boolean getDefault) {
        String defaultValue = SlimActionConstants.ACTION_CAMERA;
        if (getDefault) {
            return defaultValue;
        }
        String value = Settings.System.getStringForUser(
